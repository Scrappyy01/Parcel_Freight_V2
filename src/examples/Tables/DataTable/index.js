...
IJV - 2024.08.29  -  new improved Unquoted Jobs list using Material UI table layout.
*/
...
function DataTable({
  ...
  const tableInstance = useTable(
    { columns, data, initialState: { ...initialState, pageIndex: 0 } },
    useGlobalFilter,
    useSortBy,
    usePagination
  );
                ...
                {row.cells.map((cell) => {
                  ...
                  return (
                    <DataTableBodyCell
                      ...
                      {...cellProps}
                      onClick={
                        cell.column.id === "select" // 👈 if it's checkbox column
                          ? (e) => e.stopPropagation() // block click bubbling
                          : undefined
                      }
                    >
                      {cell.render("Cell")}
...
DataTable.propTypes = {
  ...
  initialState: PropTypes.object, // Add PropTypes for
};

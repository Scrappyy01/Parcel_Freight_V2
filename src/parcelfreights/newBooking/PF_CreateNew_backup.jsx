...
const PF_SingleListing = () => {
    ...
    axiosInstance
      ...
      .then((data) => {
        if (data.data.freight_id) {
          ...
          // Configurar os dados de pricing
          setFreightId(data.data.freight_id);
          const pricing = data.data.freight_pricing || [];
          setPricingRows(pricing);
          
          // Mostrar a seção de seleção de serviços
  ...
  const handleServiceChange = (quoteId) => {
    setSelectServiceQuoteId(quoteId);
  };

  const handleBackToForm = () => {
    setShowServiceSelection(false);
    setSelectServiceQuoteId("");
  ...
  const handleContinueToCheckout = () => {
    ...
    // Apenas redireciona para a próxima etapa
    router.push(`/parcel-freight/${freight_id}`);
  };
    ...
    <div className="min-h-screen py-6">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {showServiceSelection && (
          <div id="service-selection" className="mt-8 bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            <div className="p-5 md:p-6 bg-gradient-to-r from-[#132B43] to-[#1e4a6f]">
            ...
            <div className="p-5 md:p-6">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  className="py-3 px-6 bg-white border-2 border-gray-300 text-gray-700 font-semibold text-base rounded-xl hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  disabled={!selectServiceQuoteId}
                  className="py-3 px-6 bg-gradient-to-r from-[#FF7D44] to-[#ff9066] text-white font-bold text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.01] flex items-center justify-center gap-2"
                >
